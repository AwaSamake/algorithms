 ...
 *     of his/her N papers have at least h citations each, and the other N − h papers 
 ...
 *     respectively. Since the researcher has 3 papers with at least 3 citations each and 
...
class Solution {
	public int hIndex(int[] citations) {
		...
		for (int i = citations.length - 1; i > -1; --i) {
			...
			int min = Math.min(citation, paper);
			if (min > max) {
				max = min;
			}
		}
