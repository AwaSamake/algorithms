 ...
 *    each cookie j has a size sj. If sj >= gi, we can assign the cookie j to the child 
 *    i, and the child i will be content. Your goal is to maximize the number of your 
